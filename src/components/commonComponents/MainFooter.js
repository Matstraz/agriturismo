      ...
      <footer className="p-4 bg-gradient-to-t from-slate-400 to-slate-800 border-t-2 border-slate-200 text-slate-200">
        <div className="flex justify-between lg:flex-row flex-col lg:items-center">
          <div className="">
            ...
            <div className="flex mt-2 pb-5 lg:pb-0">
              <p>
                Soc Agr Monti Fabiana e c s.s, <br /> Agritusimo Le Fontanelle.
                <br /> Sede Legale: Via Osta 1228 <br />
                Ubic. Attvità: Via Ca' del Gobbo 2424 Castel del Rio (BO)
              </p>
              <p className="ml-7">
                Cell. 3357815882 <br />
                CF. 03818681201 <br />
                P.IVA 03818681201 <br /> REA BO 395940{" "}
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center md:flex-row flex-col justify-between border-t-2 border-slate-200 mt-5 pt-5 px-10">
